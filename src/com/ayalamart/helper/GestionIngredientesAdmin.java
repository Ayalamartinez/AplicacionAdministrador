...
public class GestionIngredientesAdmin {

	SharedPreferences pref_ap; 
	Editor editor_ap; 
	Context context_ap;
	int PRIVATE_MODE = 0; 
	private static final String TAG = GestionIngredientesAdmin.class.getSimpleName(); 
	...
	public GestionIngredientesAdmin(Context context_c){
